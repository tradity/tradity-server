...
StocksDB.prototype.updateRanking = function(cb) {
	...
	this.query('SET @rank4 := 0; REPLACE INTO ranking(`type`,uid,rank) SELECT "general-week",   id, @rank4 := @rank4 + 1 FROM users WHERE deletiontime IS NULL ORDER BY tradecount > 0 DESC, totalvalue / weekstarttotalvalue DESC', [], function() {
